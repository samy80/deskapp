			...
			<div class="min-height-200px">
				...
				<div class="icon-list pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<ul class="fontawesome-icon-list ionicons-list d-flex flex-wrap">
						...
						<li class="fa-hover" data-toggle="tooltip" data-placement="bottom" title="Click To Copy Code"><a href="javascript:;"><i class="icon-copy ion-ios-americanfootball-outline"></i></a></li>
